package com.zel.framework.aspectj;
...
import com.zel.common.enums.BusinessStatus;
import com.zel.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.zel.common.annotation.Log)")
